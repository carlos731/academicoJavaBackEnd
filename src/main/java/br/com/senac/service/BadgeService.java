...
import br.com.senac.repository.BadgeRepository;
...
public class BadgeService {
	...
	public Optional<BadgeDTO> obterPorId(Integer id){
	...
	public List<BadgeDTO> obterPorNivel(Integer id){
	...
	public BadgeDTO atualizar(Integer id, BadgeDTO badgeDto) {
